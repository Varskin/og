      ...
      message.channel.send({
        embed: {
          ...
          description: `To get the list of commands, type \`${message.guild.prefix[0]}commands\`.` +
                       ...
                       `\n\nNeed help or support with Superbot?\n${message.guild.id === '439263365483855902' ? 'Ask for help in the <#267022940967665664> channel.' : 'Join [**Superbot HQ**](https://discord.gg/XnYbAn) for testing the commands or any help you need with the bot or maybe just for fun.\nhttps://discord.gg/XnYbAn'}`,
          fields: [
            {
              name: 'Superbot HQ Invite Link',
