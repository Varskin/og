      ...
      message.channel.send({
        embed: {
          ...
          description: `To get the list of commands, type \`${message.guild.prefix[0]}commands\`.` +
                       ...
                       `\n\nNeed help or support with Superbot?\n${message.guild.id === '439263365483855902' ? 'Ask for help in the <#441072823432118283> channel.' : 'Join [**Superbot HQ**](https://discord.gg/XnYbAn) for testing the commands or any help you need with the bot or maybe just for fun.\nhttps://discord.gg/XnYbAn'}`,
          fields: [
            {
